"""
munich_display.py — UNIFIED
==================
Dashboard, gráfico ASCII, order book, posições e logging CSV.
Suporta: ensemble breakdown, dual forecast, phased entry, risk-first.
"""
...
def display(now, latest_obs, temps_by_hour, series_today, signals, p,
    ...
    if phased is not None:
        is_single = hasattr(phased, 'bought') and not hasattr(phased, 'parcel_bought')
